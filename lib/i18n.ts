export const translations = {
  en: {
    ...
    hero: {
      badge: 'Open to Collaborate on Product & AI Projects',
      title: 'Andre Ganske',
      subtitle: 'Intelligent systems for people & bussiness',
      description: 'Senior Product Manager | AI & Risk Intelligence | Product-Led Growth | Human-Centered IA',
      cta1: 'Get in Touch',
      cta2: 'View My Work',
    },
    about: {
  ...
  pt: {
    ...
    hero: {
      badge: 'Aberto a colaborar em projetos de Produto e IA',
      title: 'Andre Ganske',
      subtitle: 'Sistemas inteligentes para pessoas & negócios',
      description: 'Senior Product Manager | IA & Inteligência de Risco | Product-Led Growth | IA Centrada no Humano',
