export const translations = {
  en: {
    ...
    aiProjects: {
      ...
      neurobloom: 'AI-first app to help people overcome cold-call anxiety and prepare for conversations more effectively',
      attractor: 'AI-first financial app for couples using open finance and ephemeral UI to improve their relationship with money',
      veritrace: 'AI focused on fraud detection in images and documents',
      pmfofo: 'Custom GPT to support PMs in building customized career plans aligned with company needs',
    },
    newsletter: {
      badge: 'Newsletter',
  ...
  pt: {
    ...
    aiProjects: {
      ...
      neurobloom: 'App AI-first para ajudar pessoas a superarem a ansiedade de cold-calls e se prepararem para conversas de forma mais efetiva',
      attractor: 'App financeiro AI-first para casais que utiliza open finance e UI efêmera para melhorar a relação dos casais com o dinheiro',
      veritrace: 'IA com foco na identificação de fraudes em imagens e documentos',
      pmfofo: 'GPT customizado para apoiar PMs na construção de planos de carreira customizados e alinhados às necessidades da empresa',
    },
    newsletter: {
      badge: 'Newsletter',
