...
export default function Footer() {
  ...
  const socialLinks = [
    { label: 'LinkedIn', href: 'https://linkedin.com/in/andreganske', icon: 'linkedin' },
    { label: 'Substack', href: 'https://featureoubug.substack.com', icon: 'substack' },
    { label: 'GitHub', href: 'https://github.com/andreganske', icon: 'github' },
  ]
